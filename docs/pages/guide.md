...
## Introduction
LG4X-V2 is based on the great work of  [Hideki NAKAJIMA](https://github.com/hidecode221b) who developed the software [LG4X](https://github.com/hidecode221b/LG4X). 
LGX4 was published under the MIT License. For more information please refer to the License of [LG4X-V2](https://github.com/Julian-Hochhaus/LG4X-V2/blob/638f548e9daca3363f4a7f898de0cc8c1303c80b/LICENSE). 
The following README is currently under revision and was originally written by [Hideki NAKAJIMA](https://github.com/hidecode221b) for [LG4X](https://github.com/hidecode221b/LG4X), therefore several features of LG4X-V2 are not yet documented!

## Installation and Requirements: 
Please read the [Setup](/pages/setup/)-section for an installation instruction.
...
This guide is based on the guide [Hideki NAKAJIMA](https://github.com/hidecode221b) has written for the predecessor software [LG4X](https://github.com/hidecode221b/LG4X). It was adapted to reflect the changes introduced in LG4X-V2.
