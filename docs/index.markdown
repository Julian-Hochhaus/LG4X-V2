...
title: Home
nav_order: 1
description: "LG4X-V2 is an open-source GUI for X-ray photoemission spectroscopy (XPS) curve fitting based on the python lmfit package."
permalink: /
---
...
[View it on GitHub](https://github.com/Julian-Hochhaus/LG4X-V2){: .btn .fs-5 .mb-4 .mb-md-0 }
...
LG4X-V2 is &copy; 2022-{{ "now" | date: "%Y" }} by [Julian Andreas Hochhaus](https://github.com/Julian-Hochhaus) and is inspired by its predecessor software [LG4X](https://github.com/hidecode221b/LG4X) by [Hideki Nakajima](https://github.com/hidecode221b).
